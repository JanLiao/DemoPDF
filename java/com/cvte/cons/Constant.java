...
public class Constant {
	...
	public static String DEST = "/home/intern1/jan/web/tomcat/webapps/GlaucomaCVTE/img";  //虚拟数据转移到的路径
	...
	public static String csvConsole = "/home/intern1/jan/web/tomcat/webapps/GlaucomaCVTE/csvConsole";  //一张图片生成一个csv文件
	public static String csvReport = "/home/intern1/jan/web/tomcat/webapps/GlaucomaCVTE/csvReport";   //csv合成报告
	public static String csvLog = "/home/intern1/jan/web/tomcat/webapps/GlaucomaCVTE/csvLogger";
	
	//public static String ImgServerPath = "C:/Users/CVTE/Desktop/img";  //服务器保存图片路径  == ImgProcess 检查路径
	public static String ImgServerPath = "/home/intern1/jan/web/tomcat/webapps/GlaucomaCVTE/img";  //PC端传输图片保存路径
	public static String ImgResultPath = "/home/intern1/jan/web/tomcat/webapps/GlaucomaCVTE/imgResult";  //AI生成图片保存路径
